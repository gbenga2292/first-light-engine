...
interface SiteConsumablesAnalyticsViewProps {
    site: Site;
    assets: Asset[];
    consumableLogs: ConsumableUsageLog[];
}

export const SiteConsumablesAnalyticsView = ({
    site,
    assets,
    consumableLogs
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold tracking-tight">Site Consumables Analytics - {site.name}</h2>
            </div>
